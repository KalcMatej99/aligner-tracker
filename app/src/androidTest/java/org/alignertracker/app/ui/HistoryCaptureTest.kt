...
/** Reproducible synthetic History-only emulator captures, not a human usability test. */
class HistoryCaptureTest {
                ...
                MaterialTheme(
                    ...
                    Surface(Modifier.safeDrawingPadding().width(c.width.dp).fillMaxHeight()) {
                        ...
                        key(c.name, wearing) {
                            ...
                            HistoryScreen(snapshot, now, c.busy, {})
                        }
                    }
                }
            }
    ...
    private fun capture(name: String) {
        ...
        val output =
            File(instrumentation.targetContext.getExternalFilesDir(null), "history-focus/$name.png")
