...
Read docs/product.md, docs/architecture.md, docs/roadmap.md and your assigned Forgejo issue before changes. Repository: https://forgejo.server.matejkalc.com/matejkalc/aligner-tracker. One app module, namespace org.alignertracker.app. No competitor code/assets/content. No secrets, network permission, analytics or background ticking service.
