...
Current private release: **1.1.2 (versionCode 15)**. [Release details](release15.md),
[deployment receipt](https://forgejo.server.matejkalc.com/matejkalc/aligner-tracker/issues/68),
and [phone APK](https://apps.server.matejkalc.com/fdroid/repo/org.alignertracker.app_15.apk)
(Tailscale required). The approved timeline update retains the Now marker and uses
continuous outlined OUT blocks without inline text.

Previous private release: **1.1.0 (versionCode 12)**, published on 2026-09-11 at the owner's explicit request. [Download 1.1.0](https://apps.server.matejkalc.com/fdroid/repo/org.alignertracker.app_12.apk) while connected to Tailscale, or refresh Kalc Apps in F-Droid.
